        ...
        <div className="relative bg-white/5 backdrop-blur-lg rounded-xl border border-white/10 overflow-hidden">
          <div className="flex items-center p-6">
            ...
            <a
              ...
              className="ml-8 flex flex-col h-[250px] justify-between flex-grow hover:bg-white/10 transition rounded-lg p-2"
            >
              <div>
                ...
                <p className="text-gray-300">{news[currentIndex].summary}</p>
              </div>
            </a>
          </div>
